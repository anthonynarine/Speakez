 ...
 *
 * This component renders the AppBar with server details, a drawer toggle button for small screens,
 * and a Drawer component to display the server channels. It uses a responsive drawer hook to manage
 * the drawer state.
 *
 * @component
